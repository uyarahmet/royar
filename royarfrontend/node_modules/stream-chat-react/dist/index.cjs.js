        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [3 /*break*/, 4];
                case 2: return [4 /*yield*/, channel.deleteReaction(id, type)];
                case 3:
                    _a.sent();
                    _a.label = 4;
...
var ChannelInner = function (props) {
    ...
    var channelStateContextValue = __assign(__assign({}, restState), { acceptedFiles: acceptedFiles,
        channel: channel,
        ...
        quotedMessage: quotedMessage, watcher_count: state.watcherCount });
...
var MessageWithContext = function (props) {
    ...
    var messageContextValue = __assign(__assign({}, rest), { actionsEnabled: actionsEnabled, clearEditingState: clearEdit, editing: editing, getMessageActions: messageActionsHandler, handleEdit: setEdit, isMyMessage: function () { return isMyMessage; }, onUserClick: onUserClick,
        onUserHover: onUserHover, setEditingState: setEdit });
...
var VirtualizedMessageListWithContext = function (props) {
    ...
    var _j = useComponentContext(), _k = _j.DateSeparator, DateSeparator$1 = _k === void 0 ? DateSeparator : _k, _l = _j.EmptyStateIndicator, EmptyStateIndicator$1 = _l === void 0 ? EmptyStateIndicator : _l, _m = _j.LoadingIndicator, LoadingIndicator$1 = _m === void 0 ? LoadingIndicator : _m, _o = _j.MessageNotification, MessageNotification$1 = _o === void 0 ? MessageNotification : _o, _p = _j.MessageSystem, MessageSystem = _p === void 0 ? EventComponent : _p, _q = _j.TypingIndicator, TypingIndicator = _q === void 0 ? null : _q, _r = _j.VirtualMessage, contextMessage = _r === void 0 ? FixedHeightMessage : _r;
    var t = useTranslationContext().t;
    var lastRead = React.useMemo(function () { var _a; return (_a = channel.lastRead) === null || _a === void 0 ? void 0 : _a.call(channel); }, [channel]);
    var MessageUIComponent = propMessage || contextMessage;
...
function VirtualizedMessageList(props) {
    ...
    return (React__default['default'].createElement(VirtualizedMessageListWithContext, __assign({ channel: channel, client: client, hasMore: !!hasMore, loadingMore: !!loadingMore, loadMore: loadMore, messages: messages }, props)));
}
